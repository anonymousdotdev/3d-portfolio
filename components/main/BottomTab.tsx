...
const BottomTab = () => {
    return (
        <div>
            ...
            <div className="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2  border border-[#7042f861] bg-[#0300145e]  rounded-full bottom-4 left-1/2 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50">
