...
const profile = {
  ...
  return (
    <>
      <main className="pt-20 lg:pt-[0rem] bg-gradient-to-b  text-white min-h-screen">
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:py-0">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                ...
                Mobile, and Software development. I&apos;m passionate about building web applications that are fast, secure, and user-friendly. I&apos;m constantly learning new technologies 💻✨
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                // target="_blank"
                href="#"
                  // href="../../assets/Shah-Hussain-Full-Stack-Dev.pdf" 
             ...
             <div className="w-full lg:w-1/2 animate__animated animate__fadeInDown animate__delay-0.1s mt-24">
              <div className="gradient-border">
                <div className="code-window bg-[#091121]">
                  <div className="window-header">
                    <div className="window-dot bg-red-500 animate-pulse"></div>
                    <div className="window-dot bg-yellow-500 animate-pulse"></div>
                    <div className="window-dot bg-green-500 animate-pulse"></div>
